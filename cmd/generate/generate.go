...
func main() {
	...
	enumMap := map[string]string{
		...
		"istio.networking.v1alpha3.Server_TLSOptions_TLSmode":                  "me.snowdrop.istio.api.model.v1.networking.TLSOptionsMode",
		"istio.networking.v1alpha3.TLSSettings_TLSmode":                        "me.snowdrop.istio.api.model.v1.networking.TLSSettingsMode",
