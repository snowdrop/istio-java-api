...
public class PolicyOperationImpl extends HasMetadataOperation<Policy, PolicyList, DoneablePolicy, Resource<Policy, DoneablePolicy>> {
  ...
  public PolicyOperationImpl(OkHttpClient client, Config config, String namespace) {
  ...
  public PolicyOperationImpl(OkHttpClient client, Config config, String apiVersion, String namespace, String name, Boolean cascading, Policy item, String resourceVersion, Boolean reloadingFromServer, long gracePeriodSeconds, Map<String, String> labels, Map<String, String> labelsNot, Map<String, String[]> labelsIn, Map<String, String[]> labelsNotIn, Map<String, String> fields) {
    super(client, config, null, apiVersion, "Policys", namespace, name, cascading, item, resourceVersion, reloadingFromServer, gracePeriodSeconds, labels, labelsNot, labelsIn, labelsNotIn, fields);
  }
}
