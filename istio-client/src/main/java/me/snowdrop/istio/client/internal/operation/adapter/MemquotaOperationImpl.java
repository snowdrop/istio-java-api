...
public class MemquotaOperationImpl extends HasMetadataOperation<Memquota, MemquotaList, DoneableMemquota, Resource<Memquota, DoneableMemquota>> {
  ...
  public MemquotaOperationImpl(OkHttpClient client, Config config, String namespace) {
  ...
  public MemquotaOperationImpl(OkHttpClient client, Config config, String apiVersion, String namespace, String name, Boolean cascading, Memquota item, String resourceVersion, Boolean reloadingFromServer, long gracePeriodSeconds, Map<String, String> labels, Map<String, String> labelsNot, Map<String, String[]> labelsIn, Map<String, String[]> labelsNotIn, Map<String, String> fields) {
    super(client, config, null, apiVersion, "Memquotas", namespace, name, cascading, item, resourceVersion, reloadingFromServer, gracePeriodSeconds, labels, labelsNot, labelsIn, labelsNotIn, fields);
  }
}
