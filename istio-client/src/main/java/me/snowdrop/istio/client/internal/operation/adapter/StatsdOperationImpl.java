...
public class StatsdOperationImpl extends HasMetadataOperation<Statsd, StatsdList, DoneableStatsd, Resource<Statsd, DoneableStatsd>> {
  ...
  public StatsdOperationImpl(OkHttpClient client, Config config, String namespace) {
  ...
  public StatsdOperationImpl(OkHttpClient client, Config config, String apiVersion, String namespace, String name, Boolean cascading, Statsd item, String resourceVersion, Boolean reloadingFromServer, long gracePeriodSeconds, Map<String, String> labels, Map<String, String> labelsNot, Map<String, String[]> labelsIn, Map<String, String[]> labelsNotIn, Map<String, String> fields) {
    super(client, config, null, apiVersion, "Statsds", namespace, name, cascading, item, resourceVersion, reloadingFromServer, gracePeriodSeconds, labels, labelsNot, labelsIn, labelsNotIn, fields);
  }
}
