...
public class BypassOperationImpl extends HasMetadataOperation<Bypass, BypassList, DoneableBypass, Resource<Bypass, DoneableBypass>> {
  ...
  public BypassOperationImpl(OkHttpClient client, Config config, String namespace) {
  ...
  public BypassOperationImpl(OkHttpClient client, Config config, String apiVersion, String namespace, String name, Boolean cascading, Bypass item, String resourceVersion, Boolean reloadingFromServer, long gracePeriodSeconds, Map<String, String> labels, Map<String, String> labelsNot, Map<String, String[]> labelsIn, Map<String, String[]> labelsNotIn, Map<String, String> fields) {
    super(client, config, null, apiVersion, "Bypasss", namespace, name, cascading, item, resourceVersion, reloadingFromServer, gracePeriodSeconds, labels, labelsNot, labelsIn, labelsNotIn, fields);
  }
}
