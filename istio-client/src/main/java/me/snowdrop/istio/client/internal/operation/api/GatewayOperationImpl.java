...
public class GatewayOperationImpl extends HasMetadataOperation<Gateway, GatewayList, DoneableGateway, Resource<Gateway, DoneableGateway>> {
  ...
  public GatewayOperationImpl(OkHttpClient client, Config config, String namespace) {
  ...
  public GatewayOperationImpl(OkHttpClient client, Config config, String apiVersion, String namespace, String name, Boolean cascading, Gateway item, String resourceVersion, Boolean reloadingFromServer, long gracePeriodSeconds, Map<String, String> labels, Map<String, String> labelsNot, Map<String, String[]> labelsIn, Map<String, String[]> labelsNotIn, Map<String, String> fields) {
    super(client, config, null, apiVersion, "Gateways", namespace, name, cascading, item, resourceVersion, reloadingFromServer, gracePeriodSeconds, labels, labelsNot, labelsIn, labelsNotIn, fields);
  }
}
